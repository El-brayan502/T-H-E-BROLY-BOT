...
“ 𝐇𝐎𝐋𝐀 𝐀𝐌𝐈𝐆@ *%name* 𝐒𝐎𝐘 *𝐁 𝐑 𝐎 𝐋 𝐘 - 𝐁 𝐎 𝐓*, %greeting ”

╭────═[ *𝗜 𝗡 𝗙 𝗢 - 𝗕 𝗥 𝗢 𝗟 𝗬*]═─────⋆
│╭───────────────···
┴│✦ *🇬🇹 𝐌 𝐎 𝐃 𝐎* : Público
❒│✦ *👻 𝐁𝐀𝐈𝐋𝐄𝐘𝐒* : Multi Device
❒│✦ *🛂 𝐓𝐈𝐄𝐌𝐏𝐎 Activo* : %muptime
┬│✦ *🚹 𝐔𝐒𝐔𝐀𝐑𝐈𝐎𝐒* : %totalreg
│╰────────────────···
╰───────────═┅═──────────
%readmore
...
\t\t\t*L I S T A  -  M E N Ú S*
`.trimStart(),
  header: '╭───═[ `𝑺 𝑼 𝑷 𝑬 𝑹 𝑴𝑬𝑵Úメ %category` ]═────⋆\n│╭───────────────···',
...
let handler = async (m, { conn, usedPrefix: _p, __dirname }) => {
  try {
    ...
    let img = await (await fetch(`https://telegra.ph/file/5f2939a4af0a4ca20d877.jpg`)).buffer()
    await m.react('🍁')
